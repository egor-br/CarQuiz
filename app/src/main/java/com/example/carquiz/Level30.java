...
public class Level30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level30);
        ...
        prviewimg.setImageResource(R.drawable.honda);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level30_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level30.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level30_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level30.this, Level31.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level30.this, R.anim.alpha);
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_honda[numleft]);
            img_left.setImageResource(array.qw_otvet_honda[numleft]);
            img_right.setImageResource(array.qw_anti_otvet_honda[numleft]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_honda[numright]);
            img_right.setImageResource(array.qw_otvet_honda[numright]);
            img_left.setImageResource(array.qw_anti_otvet_honda[numright]);
        }
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 30){
                            ...
                            editor.putInt("Level", 31);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level30True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level30True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level30False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
