...
public class Level40 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level40);
        ...
        prviewimg.setImageResource(R.drawable.brit);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level40_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level40.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level40_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setText("Меню");
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level40.this, MainActivity.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level40.this, R.anim.alpha);
        ...
        switch (win_qwest){
            case 0:
                ...
                img_one.setImageResource(array.img_brit[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_franz[numleft]);
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_germani[numleft]);
                break;
            case 1:
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_brit[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_franz[numleft]);
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_germani[numleft]);
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level40True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level40True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level40False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <10) {
                            Toast toast = Toast.makeText(Level40.this,"Открыто достижение знаток британских авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 10);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
