...
public class Level36 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level36);
        ...
        prviewimg.setImageResource(R.drawable.germani);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level36_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level36.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level36_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level36.this, Level37.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level36.this, R.anim.alpha);
        ...
        switch (win_qwest){
            case 0:
                ...
                img_one.setImageResource(array.img_germani[numleft]);
                numleft = random.nextInt(10);
            ...
            case 1:
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_germani[numleft]);
                numleft = random.nextInt(10);
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 36){
                            ...
                            editor.putInt("Level", 37);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level36True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level36True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level36False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <6) {
                            Toast toast = Toast.makeText(Level36.this,"Открыто достижение знаток немецких авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 6);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
