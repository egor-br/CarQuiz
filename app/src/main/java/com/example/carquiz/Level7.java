...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level7);
        ...
        textpriew.setText(R.string.level7_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level7.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level7_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        if(win_qwest == 0) {
            ...
            img_left.setImageResource(array.images_audi[numleft]);
            numright = random.nextInt(26);
            img_right.setImageResource(array.images_anti_audi[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            img_right.setImageResource(array.images_audi[numright]);
            numleft = random.nextInt(26);
            img_left.setImageResource(array.images_anti_audi[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level7True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level7True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level7False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
