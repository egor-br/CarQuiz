...
public class Level33 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level33);
        ...
        prviewimg.setImageResource(R.drawable.ru);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level33_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level33.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level33_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level33.this, Level34.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level33.this, R.anim.alpha);
        ...
        switch (win_qwest){
            case 0:
                ...
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
            ...
            case 1:
                ...
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_yupon[numleft]);
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_germani[numleft]);
            ...
            case 2:
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
            ...
            case 3:
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_yupon[numleft]);
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 33){
                            ...
                            editor.putInt("Level", 34);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level33True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level33True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level33False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <3) {
                            Toast toast = Toast.makeText(Level33.this,"Открыто достижение знаток русских авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 3);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
