...
public class Level22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level22);
        ...
        prviewimg.setImageResource(R.drawable.nissan);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level22_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level22.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level22_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level22.this, R.anim.alpha);
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_nissam[numleft]);
            img_left.setImageResource(array.qw_otvet_nissam[numleft]);
            img_right.setImageResource(array.qw_anti_otvet_nissam[numleft]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_nissam[numright]);
            img_right.setImageResource(array.qw_otvet_nissam[numright]);
            img_left.setImageResource(array.qw_anti_otvet_nissam[numright]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level22True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level22True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level22False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
