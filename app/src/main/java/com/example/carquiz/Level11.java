...
public class Level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textpriew.setText(R.string.level11_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level11.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level11_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        if(win_qwest == 0) {
            ...
            img_left.setImageResource(array.images_honda[numleft]);
            numright = random.nextInt(26);
            img_right.setImageResource(array.images_anti_honda[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            img_right.setImageResource(array.images_honda[numright]);
            numleft = random.nextInt(26);
            img_left.setImageResource(array.images_anti_honda[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level11True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level11True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level11False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
