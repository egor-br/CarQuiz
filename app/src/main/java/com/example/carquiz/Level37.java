...
public class Level37 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level37);
        ...
        prviewimg.setImageResource(R.drawable.franz);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level37_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level37.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level37_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level37.this, Level38.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level37.this, R.anim.alpha);
        ...
        switch (win_qwest){
            ...
            case 3:
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_franz[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_usa[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_ital[numleft]);
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 37){
                            ...
                            editor.putInt("Level", 38);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level37True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level37True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level37False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <7) {
                            Toast toast = Toast.makeText(Level37.this,"Открыто достижение знаток французких авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 7);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
