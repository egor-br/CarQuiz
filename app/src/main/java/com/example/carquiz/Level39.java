...
public class Level39 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level39);
        ...
        prviewimg.setImageResource(R.drawable.ital);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level39_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level39.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level39_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level39.this, Level40.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level39.this, R.anim.alpha);
        ...
        switch (win_qwest){
            ...
            case 3:
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_franz[numleft]);
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 39){
                            ...
                            editor.putInt("Level", 40);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level39True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level39True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level39False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <9) {
                            Toast toast = Toast.makeText(Level39.this,"Открыто достижение знаток итальянских авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 9);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
