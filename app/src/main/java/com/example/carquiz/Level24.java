...
public class Level24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level24);
        ...
        prviewimg.setImageResource(R.drawable.mazda);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level24_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level24.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level24_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level24.this, R.anim.alpha);
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_mazda[numleft]);
            img_left.setImageResource(array.qw_otvet_mazda[numleft]);
            img_right.setImageResource(array.qw_anti_otvet_mazda[numleft]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_mazda[numright]);
            img_right.setImageResource(array.qw_otvet_mazda[numright]);
            img_left.setImageResource(array.qw_anti_otvet_mazda[numright]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level24True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level24True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level24False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
