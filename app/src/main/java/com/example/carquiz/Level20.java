...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level20);
        ...
        prviewimg.setImageResource(R.drawable.subaru);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level20_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level20.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level20_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level20.this, R.anim.alpha);
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_subar[numleft]);
            img_left.setImageResource(array.qw_otvet_subar[numleft]);
            numright = random.nextInt(10);
            img_right.setImageResource(array.qw_anti_otvet_subar[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_subar[numright]);
            img_right.setImageResource(array.qw_otvet_subar[numright]);
            numleft = random.nextInt(10);
            img_left.setImageResource(array.qw_anti_otvet_subar[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level20True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level20True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level20False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
