...
public class Level17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level17);
        ...
        prviewimg.setImageResource(R.drawable.lada);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level17_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level17.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level17_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_lada[numleft]);
            img_left.setImageResource(array.qw_otvet_lada[numleft]);
            numright = random.nextInt(10);
            img_right.setImageResource(array.qw_anti_otvet_lada[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_lada[numright]);
            img_right.setImageResource(array.qw_otvet_lada[numright]);
            numleft = random.nextInt(10);
            img_left.setImageResource(array.qw_anti_otvet_lada[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level17True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level17True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level17False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
