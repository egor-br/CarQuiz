...
public class Level32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level32);
        ...
        prviewimg.setImageResource(R.drawable.peugeot);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level32_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level32.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level32_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level32.this, Level33.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level32.this, R.anim.alpha);
        ...
        if(win_qwest == 0) {
            ...
            text_qw.setText(array.qw_peug[numleft]);
            img_left.setImageResource(array.qw_otvet_peug[numleft]);
            img_right.setImageResource(array.qw_anti_otvet_peug[numleft]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            text_qw.setText(array.qw_peug[numright]);
            img_right.setImageResource(array.qw_otvet_peug[numright]);
            img_left.setImageResource(array.qw_anti_otvet_peug[numright]);
        }
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 32){
                            ...
                            editor.putInt("Level", 33);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level32True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level32True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level32False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <2) {
                            Toast toast = Toast.makeText(Level32.this,"Открыто достижение знаток истории", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 2);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else{
