    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level1.this, ActivityChoiceLevel.class);
        ...
        if(win_qwest == 0) {
            ...
            img_left.setImageResource(array.images_sovok[numleft]);
            numright = random.nextInt(18);
            img_right.setImageResource(array.images_us_ea[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            img_right.setImageResource(array.images_sovok[numright]);
            numleft = random.nextInt(18);
            img_left.setImageResource(array.images_us_ea[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level1True",0);
                        final int false_col = save.getInt("Level1False",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level1True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level1False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
