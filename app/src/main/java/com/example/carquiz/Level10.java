...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textpriew.setText(R.string.level10_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level10.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level10_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        if(win_qwest == 0) {
            ...
            img_left.setImageResource(array.images_nissan[numleft]);
            numright = random.nextInt(26);
            img_right.setImageResource(array.images_anti_nissan[numright]);
        }else{
            numright = random.nextInt(10);
            num_test[num_col_test] = numright;
            num_col_test = num_col_test + 1;
            img_right.setImageResource(array.images_nissan[numright]);
            numleft = random.nextInt(26);
            img_left.setImageResource(array.images_anti_nissan[numleft]);
        }
            ...
            public  boolean onTouch(View v, MotionEvent event){
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        final int true_col = save.getInt("Level10True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level10True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level10False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
