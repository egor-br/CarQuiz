...
public class Level34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level34);
        ...
        prviewimg.setImageResource(R.drawable.china);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level34_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level34.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level34_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level34.this, Level35.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level34.this, R.anim.alpha);
        ...
        switch (win_qwest){
            ...
            case 2:
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_franz[numleft]);
                numleft = random.nextInt(10);
            ...
            case 3:
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_china[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_franz[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_yupon[numleft]);
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 34){
                            ...
                            editor.putInt("Level", 35);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level34True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level34True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level34False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <4) {
                            Toast toast = Toast.makeText(Level34.this,"Открыто достижение знаток китайских авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 4);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
