...
public class Level38 extends AppCompatActivity {
    ...
    public int num_col_test = 0, col_false=0,col_true=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_level.setText(R.string.level38);
        ...
        prviewimg.setImageResource(R.drawable.usa);
        TextView textpriew = (TextView)dialog.findViewById(R.id.description);
        textpriew.setText(R.string.level38_text);
        ...
        btn_clos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level38.this, ActivityChoiceLevel.class);
        ...
        textEnd.setText(R.string.level38_text_end);
        //кнопка которая закрывает диалоговая окно
        ...
        btn_contin_end.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Level38.this, Level39.class);
        ...
        //подключаем анимацию
        final Animation animation = AnimationUtils.loadAnimation(Level38.this, R.anim.alpha);
        ...
        switch (win_qwest){
            case 0:
                ...
                img_one.setImageResource(array.img_usa[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_brit[numleft]);
                break;
            case 1:
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_usa[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_brit[numleft]);
            ...
            case 2:
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_usa[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
            ...
            case 3:
                numleft = random.nextInt(10);
                img_four.setImageResource(array.img_usa[numleft]);
                numleft = random.nextInt(10);
                img_one.setImageResource(array.img_ru[numleft]);
                numleft = random.nextInt(10);
                img_two.setImageResource(array.img_ital[numleft]);
                numleft = random.nextInt(10);
                img_three.setImageResource(array.img_brit[numleft]);
                break;
        }
                ...
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(count >= 10){//выход из уровня
                        ...
                        if(level > 38){
                            ...
                            editor.putInt("Level", 39);
                            editor.commit();
                        }
                        final int true_col = save.getInt("Level38True",0);
                        if(true_col == 0) {
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("Level38True", col_true);
                            SharedPreferences.Editor editor2 = save.edit();
                            editor2.putInt("Level38False", col_false);
                            editor.commit();
                            editor2.commit();
                        }else {
                        ...
                        if(level_1 <8) {
                            Toast toast = Toast.makeText(Level38.this,"Открыто достижение знаток американских авто", Toast.LENGTH_LONG);
                            toast.setGravity(Gravity.TOP,0,0);
                            toast.show();
                            SharedPreferences.Editor editor = save.edit();
                            editor.putInt("LevelAchiv", 8);
                            editor.commit();
                        }
                        dialogEnd.show();
                    }else {
